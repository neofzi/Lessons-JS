...
//! Задача №3.1
// Загальну вартість (нові ціни)
let newPrice = dataList.reduce((total, product) => total + product.price, 0);
console.log(newPrice);

//! Задача №3.2
// Знайти кількість товарів, у яких ціна зменшилась (price < old_price).
let lowerPrice = dataList.filter(
  (product) => product.price < product.old_price
).length;
